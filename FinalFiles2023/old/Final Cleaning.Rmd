...
### READING IN DATA ###
```{r}
data1415 <- read.csv("/Users/ajaypatel21/Desktop/Frost/Original Files/MergedBothYear1_Ajay.csv", stringsAsFactors = T)
data1516 <- read.csv("/Users/ajaypatel21/Desktop/Frost/Original Files/Final1516Jan6.csv", stringsAsFactors = T)
data1617 <- read.csv("/Users/ajaypatel21/Desktop/Frost/Original Files/Final_16-17_Data_cleaningcoderun_Ajay.csv", stringsAsFactors = T)
...
```{r}
write.csv(data1415, "test1.csv")
write.csv(data1516, "test2.csv")
write.csv(data1617, "test3.csv")
```
...
data1415_post <- read.csv("/Users/ajaypatel21/Desktop/Frost/test1.csv", stringsAsFactors = T)
data1516_post <- read.csv("/Users/ajaypatel21/Desktop/Frost/test2.csv", stringsAsFactors = T)
data1617_post <- read.csv("/Users/ajaypatel21/Desktop/Frost/test3.csv", stringsAsFactors = T)
...
write.csv(condensed, "Condensed Final v3.csv")
```
...
write.csv(data_final, "All Years Final v3.csv")
...
write.csv(data_public, "All Years Final v3 Public.csv")
```
...
write.csv(instiution_anonymized_data, "Institution_Name_Anonymized_Data.csv")
write.csv(instructor_anonymized_data, "Instructor_Name_Anonymized_Data.csv")
```
