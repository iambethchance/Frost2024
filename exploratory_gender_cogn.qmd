...
Is instructor gender a predictor of Post Cog Comp?
```{r}
instruct_gender_comp.fit <- lm(cognitive.competence.post ~ instructor.gender + gender + instructor.gender:gender, data = allYrsFinal)

plot(resid(instruct_gender_comp.fit) ~ fitted(instruct_gender_comp.fit), xlab = "Fitted", ylab="Residuals")
abline(h=0, lty = "dashed")
#normal Q-Q plot of residuals 
qqnorm(resid(instruct_gender_comp.fit), ylab="Residuals"); qqline(resid(instruct_gender_comp.fit), lty = "dashed")
#histogram of residuals=> skewed left
hist(resid(instruct_gender_comp.fit), main = '', col="olivedrab", xlab = "Residuals")
```
Transformations? (don't know how to fix bimodal)
```{r}
instruct_gender_comp.fit2 <- lm((cognitive.competence.post)^1.5 ~ instructor.gender + gender + instructor.gender:gender, data = allYrsFinal)

plot(resid(instruct_gender_comp.fit2) ~ fitted(instruct_gender_comp.fit2), xlab = "Fitted", ylab="Residuals")
abline(h=0, lty = "dashed")
#normal Q-Q plot of residuals 
qqnorm(resid(instruct_gender_comp.fit2), ylab="Residuals"); qqline(resid(instruct_gender_comp.fit2), lty = "dashed")
#histogram of residuals=> skewed left
hist(resid(instruct_gender_comp.fit2), main = '', col="olivedrab", xlab = "Residuals")
```
Kruskall Wallis
```{r}
kruskal.test(cognitive.competence.post ~ instructor.gender, data=allYrsFinal)
```
...
Check assumptions
```{r}
text_class.fit <- lm(ach.gain.24 ~ textbook.classification + gender + textbook.classification:gender, data=allYrsFinal)
...
Transformations
```{r}
text_class.fit2 <- lm(sqrt(ach.gain.24) ~ textbook.classification + gender + textbook.classification:gender, data=allYrsFinal)
#plot(ach.gain.24~textbook.classification, data=allYrsFinal, pch=19)
...
```{r}
text_class_post.fit <- lm(cognitive.competence.post ~ textbook.classification + gender + textbook.classification:gender, data=allYrsFinal)
#plot(ach.gain.24~textbook.classification, data=allYrsFinal, pch=19)
...
Check assumptions
```{r}
textbook.fit <- lm(ach.gain.24 ~ textbook.used + gender + textbook.used:gender, data=allYrsFinal)
...
Transformations
```{r}
textbook.fit2 <- lm(sqrt(ach.gain.24) ~ textbook.used + gender + textbook.used:gender, data=allYrsFinal)
#plot(ach.gain.24~textbook.classification, data=allYrsFinal, pch=19)
...
Check assumptions (bimodal residuals?)
```{r}
textbook_post.fit <- lm(cognitive.competence.post ~ textbook.used + gender + textbook.used:gender, data=allYrsFinal)
#plot(ach.gain.24~textbook.classification, data=allYrsFinal, pch=19)
...
textbook_post.fit2 <- lm(cognitive.competence.post**1.5 ~ textbook.used + gender + textbook.used:gender, data=allYrsFinal)
#plot(ach.gain.24~textbook.classification, data=allYrsFinal, pch=19)
